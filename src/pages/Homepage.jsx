        ...
        <>
            ...
            <div className="fixed inset-0 z-10 overflow-hidden bg-[#F5F5F7]">
                ...
                <div className="z-10 min-h-screen flex flex-col items-center justify-center space-y-5">
                    <h1 className="w-full px-5 mt-14 text-6xl text-balance break-words md:text-[260px] font-extrabold tracking-tight text-[#F5F5F7] drop-shadow-lg text-center"> WORKOUT DROPLIST</h1>
                    <h1 className="w-full px-5 text-2xl text-balance break-words md:text-2xl font-extrabold tracking-tight text-[#F5F5F7]/80 drop-shadow-lg text-center"><QuoteOfTheDay/></h1>
